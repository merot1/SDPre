 ...
 public class ShapeArea {
     public static void main( String[] args ) {
         ...
         do {
             ...
             if ( choice == 1 ) {
                 ...
                 System.out.println("The area is " + computeRectangleArea(q, width1) );
             }
			else if ( choice == 4 ) {
                 System.out.print("\nLength: ");
                 ...
                 System.out.println("The area is " + computeSquareArea(length2, width2) );
			}
			else if ( choice != 5 ) {
     ...
     public static int computeRectangleArea( int length1, int width1 ) {
         return (length1 * width1);
     }

	 public static double computeSquareArea( double length2, double width2 ) {
